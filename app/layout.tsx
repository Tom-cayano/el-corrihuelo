...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      ...
      {
        url: `${SITE_URL}/images/evento-grupo.jpg`,
        width: 956,
        height: 1200,
        alt: "Celebración en El Corrihuelo — Murcia",
        type: "image/jpeg",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: `${SITE_NAME} | Casa de Celebraciones en Murcia`,
    description: SITE_DESCRIPTION,
    images: [`${SITE_URL}/images/hero-salon.jpg`],
...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  url: SITE_URL,
  image: [
    `${SITE_URL}/images/hero-salon.jpg`,
    `${SITE_URL}/images/evento-grupo.jpg`,
    `${SITE_URL}/images/terraza-piscina.jpg`,
  ],
  logo: `${SITE_URL}/images/hero-salon.jpg`,
